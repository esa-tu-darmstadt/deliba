...
group_bd_cells rp1 [get_bd_cells smartconnect_1] [get_bd_cells xlconstant_1] [get_bd_cells axi_gpio_1] [get_bd_cells axi_noc_1]
#Create a hierarchy for static region
group_bd_cells static_region [get_bd_cells smartconnect_0] [get_bd_cells xlconstant_0] [get_bd_cells versal_cips_0] [get_bd_cells clk_wizard_0] [get_bd_cells axi_gpio_0] [get_bd_cells axi_noc_0] [get_bd_cells proc_sys_reset_0]
