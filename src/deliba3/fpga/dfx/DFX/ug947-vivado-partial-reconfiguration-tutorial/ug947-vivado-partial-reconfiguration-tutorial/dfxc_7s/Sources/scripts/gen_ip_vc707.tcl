...
puts "Creating IP $ip_name at $ipDir"
  ...
  dfx_controller_v1_0::set_property -dict [list                                                               \
                  ...
                  CONFIG.VS.vs_shift.RM.rm_shift_left.BS.0.ADDRESS         0x01355C00              \
                  CONFIG.VS.vs_shift.RM.rm_shift_left.BS.0.SIZE            708260                  \
                  ...
                  CONFIG.VS.vs_shift.RM.rm_shift_right.BS.0.ADDRESS        0x01402C00              \
                  CONFIG.VS.vs_shift.RM.rm_shift_right.BS.0.SIZE           708260                  \
