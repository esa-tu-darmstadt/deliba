...
# <./axi_gpio_in_rp_zu/axi_gpio_in_rp_zu.xpr> in the current working folder.

set list_projs [get_projects -quiet]
if { $list_projs eq "" } {
   create_project axi_gpio_in_rp_zu axi_gpio_in_rp_zu -part xczu9eg-ffvb1156-2-e
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net dfx_decoupler_0_rp_intf_0 [get_bd_intf_pins axi_gpio_1/S_AXI] [get_bd_intf_pins dfx_decoupler_0/rp_intf_0]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M01_AXI [get_bd_intf_pins dfx_decoupler_0/s_intf_0] [get_bd_intf_pins smartconnect_0/M01_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins dfx_decoupler_0/aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_0/aclk1] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins proc_sys_reset_0/dcm_locked]
  connect_bd_net -net static_region_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins dfx_decoupler_0/s_axi_reg_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_1/S_AXI/Reg] -force
  assign_bd_address -offset 0xA0030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs dfx_decoupler_0/s_axi_reg/Reg] -force
  ...
  # Manually add AXI Clock and Reset ports on the DFX Decoupler
  connect_bd_net [get_bd_pins dfx_decoupler_0/intf_0_aclk] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net [get_bd_pins dfx_decoupler_0/intf_0_arstn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
