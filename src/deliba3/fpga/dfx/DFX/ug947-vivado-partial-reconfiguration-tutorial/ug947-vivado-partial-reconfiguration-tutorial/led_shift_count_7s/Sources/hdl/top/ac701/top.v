...
module top(
   ...
   input        switch,      // mapped to DIP switch bit 0
   output wire [3:0] dout		 // mapped to general purpose LEDs[0-3] for AC701
);
   ...
   wire [3:0] count_out;   // counter output
   wire [3:0] shift_out;    // shifter output
   ...
   assign dout = switch ? shift_out : count_out;
